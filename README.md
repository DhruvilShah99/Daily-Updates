...
# 07 June coding updates
1. Python program to Print a list of first and last 5 elements where the values are square of numbers between 1 and 30 (both included)
...
# 12 June coding updates
1. Write a Java program to find maximum width of a binary tree

2. Write a Python program to implement Magic Square

# 13 June coding updates
1. Write a C Program to calculate Electricity Bill

2. Write a Java Program to determine whether a given matrix is a sparse matrix

3. Java program to find the first non repeated character of a given String

4. Python Program to print the pattern of alphabets

# 14 June coding updates
1. Java program to remove specific characters in the String
